    ...
    public String processSubmit(@ModelAttribute("bookDataFormData") @Valid BookDataFormData bookDataFormData,
        ...
        if (result.hasErrors()) {
            ...
            if (book.isPresent()) {
                ...
                result.addError(new ObjectError("copyDoesNotMatch",
                        new String[]{"de.codecentric.psd.worblehat.web.insertBook.copyDoesNotMatch"},
                        new Object[]{bookDataFormData.getIsbn()}, "DEFAULT"));
                return "insertBooks";
            }
